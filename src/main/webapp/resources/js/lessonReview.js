...
$("#replyAdd").click(function(){
    ...
    form1.append("bookNum", $("#replyAdd").attr('data-lesson-review'))


    fetch('../lesson/review/add', {
        method:'POST',
        //headers:{},
        body:form1,
...
function getList(page){
    ...
    fetch("/lesson/review/list?lessonNum="+replyAdd.getAttribute('data-lesson-review')+"&page="+page, {
        method:'GET'
